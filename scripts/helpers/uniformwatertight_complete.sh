...
for file in ../../Shape-completion-with-MeshCNN/datasets/3D_Pottery/Complete_normalized/**/*.obj; do
	infile=$file
	outfile=${file//Complete_normalized/Complete_normalized_watertight}
	echo "$infile"
	echo "$outfile"
