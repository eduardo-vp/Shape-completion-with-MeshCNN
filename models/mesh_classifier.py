...
class ClassifierModel:
    ...
    # Clase para entrenar la red
    
    def __init__(self, opt):
        # opt -> parametros de la red (explicado en options/base_options)
        self.opt = opt
        self.gpu_ids = opt.gpu_ids
        self.is_train = opt.is_train
        self.device = torch.device('cuda:{}'.format(self.gpu_ids[0])) if self.gpu_ids else torch.device('cpu')
        # save_dir = './checkpoints/coseg_aliens'
        ...
        self.loss = None
        # clases - canales de salida
        self.nclasses = opt.nclasses
        # cargar o definir la red
    ...
    def backward(self, out):
        #print('A punto de usar backward')
        #print('archivo: mesh_classifier')
        #print('out is ')
        #print(out.shape)
        #print('labels is')
...
##################
    ...
    def get_accuracy(self, pred, labels):
        ...
        elif self.opt.dataset_mode == 'completion':
            # cuidadito
            pass
        return correct
